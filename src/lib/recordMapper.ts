...
export function mapAnimalBiteRecord(r: Record<string, unknown>): AnimalBiteRecord {
  ...
  return {
    ...
    exposureMunicipality: asText(pick(r, 'exposureMunicipality', 'exposure_municipality')),
    exposureBarangay: asText(pick(r, 'exposureBarangay', 'exposure_barangay')),
    exposureStreet: asText(pick(r, 'exposureStreet', 'exposure_street')),
